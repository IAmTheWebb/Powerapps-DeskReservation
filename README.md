...
Copied from [Microsoft 365 Community Sampes](https://github.com/pnp/powerapps-samples/tree/66f25ddde5ac18be1dfc227d83386928f6c5113e/samples/DeskReservation) using a copy as the original repository included multiple examples.
...
### Desk Reservations (SharePoint List)
...
* Within **Power Apps Studio**, create an empty Canvas application, once opened use the `.msapp` file using **File** > **Open** > **Browse** and select the `.msapp` file you just downloaded.
* Create the two SharePoint lists as specificed above (Desks, Desk Reservations).
* Select the **Data** tab
